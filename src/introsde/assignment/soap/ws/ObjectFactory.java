...
public class ObjectFactory {
    ...
    private final static QName _HealthProfileHistory_QNAME = new QName("http://ws.soap.assignment.introsde/", "healthProfile-history");
    ...
    private final static QName _Measure_QNAME = new QName("http://ws.soap.assignment.introsde/", "measure");
    ...
    /**
     * Create an instance of {@link MeasureProfile }
     * 
     */
    public MeasureProfile createMeasureProfile() {
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MeasureProfile }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.soap.assignment.introsde/", name = "healthProfile-history")
    public JAXBElement<MeasureProfile> createHealthProfileHistory(MeasureProfile value) {
        return new JAXBElement<MeasureProfile>(_HealthProfileHistory_QNAME, MeasureProfile.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.soap.assignment.introsde/", name = "measure")
